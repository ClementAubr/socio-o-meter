...
const qsList = [
    ...
    "Je préfère les petits rassemblements aux grandes fêtes.",
    ...
    "Je préfère passer du temps seul plutôt qu'avec des gens.",
    ...
    "Je me sens nerveux(se) lors de nouvelles rencontres.",
    "Je suis généralement à l'aise en société.",
    "Je suis ouvert(e) à de nouvelles expériences sociales.",
    "Je préfère la compagnie de quelques amis proches.",
    "Je suis introverti(e) par nature.",
    "J'ai tendance à éviter les foules.",
    "Je suis quelqu'un de timide.",
    "Je me tiens souvent à l'écart des conversations de groupe.",
    ...
    "Je suis plus à l'aise avec les amis qu'avec des inconnus.",
    "J'aime discuter de divers sujets avec différentes personnes.",
    "Je suis facile à aborder.",
    "Je préfère les interactions en ligne aux rencontres en personne.",
    "Je m'ouvre davantage une fois que je connais mieux quelqu'un.",
